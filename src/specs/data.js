import { getDistinctAttributeValues, getSeries } from './helpers';
...
export const xAxisData = getDistinctAttributeValues(chartData, 'period');
export const bars = getDistinctAttributeValues(chartData, 'name');
export const series = getSeries(chartData, 'name', bars);
